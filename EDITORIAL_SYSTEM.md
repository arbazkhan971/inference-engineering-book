...
| Code test | pass | companion/tinyengine: tsc 5.9.3 clean, zero npm deps; offline smoke suite green across repeated runs (chapters' Break-it/Prove-it cases). Gate-6 companion attack (review/gate6-companion-attack.md, 2026-08-28: 0 P0 / 7 P1 / 11 P2) fully applied — 7 P1s (iteration 58) + 10 P2s (iteration 60), repros wired into the smoke/cadence suites, the attack file kept as regression evidence (10/10 P2 attacks HELD at the fixed tree; full record in Appendix F.1) |
