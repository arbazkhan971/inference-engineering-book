...
The copyedit pass closed 2026-08-27. The gate-6 adversarial wave (claims falsifiers + cross-reference audit) landed 2026-08-28: its five P1s are applied and its eleven P2s are queued — the release seal re-opens until the P2 pass lands. After that, final proof (Kindle Previewer) is the one remaining gate before upload.
