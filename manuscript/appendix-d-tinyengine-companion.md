...
| `stream-normalizer.ts` | Chapter 12 | ~150 | 162 | one event grammar for four provider grammars |
| `cache-ledger.ts` | Chapter 14 | ~130 | 125 | the money meter |
| `rate-scheduler.ts` | Chapter 15 | ~120 | 120 | quota ledger, bucket, jitter, wave pacer |
